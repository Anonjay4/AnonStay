      ...
      <div className='flex flex-wrap items-center justify-center mt-12 gap-4 max-w-5xl mx-auto'>
        {
          hotelData.map((item, index) => (
            ...
            >
              ...
              />
              <div className='hidden absolute inset-0 md:flex flex-col justify-end p-4 text-white opacity-0 md:opacity-0 group-hover:md:opacity-100 group-hover:bg-[#fcae26]/60 transition-all duration-300'>
              ...
              <div className='md:hidden absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4'>
                ...
                <div className='mt-2 text-sm bg-white/20 text-gray-100 rounded px-2 py-1 inline-block'>
                  Click to view rooms
                </div>
              </div>
            </div>
