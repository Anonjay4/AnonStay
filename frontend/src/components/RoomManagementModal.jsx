...
const RoomManagementModal = ({ room, isOpen, onClose, onUpdate }) => {
  ...
  const handlePriceUpdate = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/room/update-price/${room._id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleDiscountUpdate = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/room/update-discount/${room._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleRemoveDiscount = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/room/remove-discount/${room._id}`, {
        method: 'DELETE',
        credentials: 'include'
      });
