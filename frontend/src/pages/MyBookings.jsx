                  ...
                  <div key={booking._id} className='p-6 hover:bg-gray-600/50 transition-colors'>
                    <div className='grid grid-cols-1 md:grid-cols-12 gap-6 items-start md:items-center'>
                      ...
                      <div className='col-span-1 md:col-span-4'>
                        <div className='flex gap-4'>
                          <img src={`http://localhost:4000/images/${booking.room.images[0]}`} alt={booking.room.roomType} className='w-20 h-14 md:w-24 md:h-20 rounded-lg object-cover flex-shrink-o' />
